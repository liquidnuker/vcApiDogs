...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Home_vue__ = __webpack_require__(96);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_19b7a970_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_Home_vue__ = __webpack_require__(109);
var disposed = false
...
var vcBreedDirectory = function vcBreedDirectory() {
  return __webpack_require__.e/* import() */(9).then(__webpack_require__.bind(null, 101));
};
...
exports.default = {
  data: function data() {
    return {
      ...
      // url for local list
      url_allBreedNames: _jsondir.jsonDir + "allbreeds.json"
    };
  },
  ...
  methods: {
    listAllBreedNames: function listAllBreedNames() {
      ...
      (0, _axios_get.axios_get)(this.url_allBreedNames).then(function (response) {
        // for local list
        _this.allBreedNames = response.data.allbreeds;
    ...
    showRandomDogImage: function showRandomDogImage() {
      ...
      (0, _axios_get.axios_get)(url).then(function (response) {
        ...
        _this2.status.randomDog = "";
        _this2.randomDogImage = (0, _shuffle.shuffle)(arr[0].message);
      }).then(function () {
        // for vcRandomDog.vue name
        _this2.randomDogName = (0, _extractfilename.extractFileName)(_this2.randomDogImage[0], false);
        _this2.isRandomDogReady = true;
      });
    },
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('vcHeader'), _vm._v(" "), _c('main', {
    ...
    staticClass: "col-sm-4 leftside lrbg"
  }, [_c('div', [_c('select', {
    ...
    staticClass: "stage"
  }, [_vm._v("\r\n          stage\r\n        ")]), _vm._v(" "), _c('div', [_c('vcBreedDirectory', {
    attrs: {
      "pr-breed-dir-items": _vm.options
    }
  })], 1)])])])])], 1)
}
var staticRenderFns = []
